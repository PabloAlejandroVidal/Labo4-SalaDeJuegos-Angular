...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, SelectorPaisComponent, HttpClientModule, MatFormFieldModule, MatSelectModule, MatInputModule, MatIconModule, MatRadioModule, MatCheckboxModule, MatButtonModule, MatCardModule],
